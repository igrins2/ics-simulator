...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_27.setGeometry(QRect(490, 7, 111, 20))
        font = QFont()
        ...
        self.sts_updated.setGeometry(QRect(600, 7, 141, 21))
        self.sts_updated.setFont(font)
        self.label_29 = QLabel(Dialog)
        self.label_29.setObjectName(u"label_29")
        self.label_29.setGeometry(QRect(60, 289, 181, 20))
        ...
        self.sts_monitor14.setGeometry(QRect(267, 436, 20, 20))
        font6 = QFont()
        ...
        self.label_18.setGeometry(QRect(501, 58, 30, 17))
        self.label_18.setFont(font3)
        self.sts_monitor12 = QLabel(Dialog)
        self.sts_monitor12.setObjectName(u"sts_monitor12")
        self.sts_monitor12.setGeometry(QRect(267, 386, 20, 20))
        self.sts_monitor12.setFont(font6)
        self.label_11 = QLabel(Dialog)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(291, 58, 121, 17))
        ...
        self.tb_Monitor.horizontalHeader().setDefaultSectionSize(112)
        ...
        self.tb_Monitor.horizontalHeader().setStretchLastSection(True)
        ...
        self.bt_start = QPushButton(Dialog)
        self.bt_start.setObjectName(u"bt_start")
        self.bt_start.setGeometry(QRect(10, 340, 121, 41))
        self.bt_stop = QPushButton(Dialog)
        self.bt_stop.setObjectName(u"bt_stop")
        self.bt_stop.setGeometry(QRect(140, 340, 51, 41))
        self.bt_manualHeat1 = QPushButton(Dialog)
        self.bt_manualHeat1.setObjectName(u"bt_manualHeat1")
        self.bt_manualHeat1.setGeometry(QRect(718, 110, 21, 22))
        self.bt_manualHeat2 = QPushButton(Dialog)
        self.bt_manualHeat2.setObjectName(u"bt_manualHeat2")
        self.bt_manualHeat2.setGeometry(QRect(718, 135, 21, 22))
        self.bt_manualHeat3 = QPushButton(Dialog)
        self.bt_manualHeat3.setObjectName(u"bt_manualHeat3")
        self.bt_manualHeat3.setGeometry(QRect(718, 160, 21, 22))
        self.bt_manualHeat4 = QPushButton(Dialog)
        self.bt_manualHeat4.setObjectName(u"bt_manualHeat4")
        self.bt_manualHeat4.setGeometry(QRect(718, 185, 21, 22))
        self.bt_manualHeat5 = QPushButton(Dialog)
        self.bt_manualHeat5.setObjectName(u"bt_manualHeat5")
        self.bt_manualHeat5.setGeometry(QRect(718, 235, 21, 22))
        self.bt_com_vm = QPushButton(Dialog)
        self.bt_com_vm.setObjectName(u"bt_com_vm")
        self.bt_com_vm.setGeometry(QRect(10, 390, 31, 27))
        self.bt_com_tc1 = QPushButton(Dialog)
        self.bt_com_tc1.setObjectName(u"bt_com_tc1")
        self.bt_com_tc1.setGeometry(QRect(50, 390, 41, 27))
        self.bt_com_tc2 = QPushButton(Dialog)
        self.bt_com_tc2.setObjectName(u"bt_com_tc2")
        self.bt_com_tc2.setGeometry(QRect(100, 390, 41, 27))
        self.bt_com_tc3 = QPushButton(Dialog)
        self.bt_com_tc3.setObjectName(u"bt_com_tc3")
        self.bt_com_tc3.setGeometry(QRect(150, 390, 41, 27))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.bt_start.setText(QCoreApplication.translate("Dialog", u"email sending: \n"
"Start", None))
        self.bt_stop.setText(QCoreApplication.translate("Dialog", u"Stop", None))
        self.bt_manualHeat1.setText(QCoreApplication.translate("Dialog", u"M", None))
        self.bt_manualHeat2.setText(QCoreApplication.translate("Dialog", u"M", None))
        self.bt_manualHeat3.setText(QCoreApplication.translate("Dialog", u"M", None))
        self.bt_manualHeat4.setText(QCoreApplication.translate("Dialog", u"M", None))
        self.bt_manualHeat5.setText(QCoreApplication.translate("Dialog", u"M", None))
        self.bt_com_vm.setText(QCoreApplication.translate("Dialog", u"VM", None))
        self.bt_com_tc1.setText(QCoreApplication.translate("Dialog", u"TC-1", None))
